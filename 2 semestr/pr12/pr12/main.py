...
class MainApp(App):
    LEVELS = ['1', '2', '3', '4', '5', '6']
    planet = {
        '1': {"source": 'assets/images/1.png', 'hp': 20},
        '2': {"source": 'assets/images/2.png', 'hp': 30},
        '3': {"source": 'assets/images/3.png', 'hp': 40},
        '4': {"source": 'assets/images/4.png', 'hp': 50},
        '5': {"source": 'assets/images/5.png', 'hp': 60},
        '6': {"source": 'assets/images/6.png', 'hp': 80}
    }
    def build(self):
        sm = ScreenManager()
